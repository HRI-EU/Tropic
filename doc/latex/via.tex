\section{Fifth order polynomial coefficients}
...
\xpp(t) & = & 20 a_5 t^3 + 12 a_4  t^2 + 6 a_3 t + 2 a_2 + \Sum_{i=0}^{n_{via}-1} 6  \pi_{a,i} (t-t_{v,i}) + 12 \pi_{v,i}  (t-t_{v,i})^2 + 20 \pi_{p,i} (t-t_{v,i})^3 \\
\end{array}
$}
\ee
%
...
%\det \left( \vD \vA - \vD \vB \vD^{-1} \vC \right)
%=
%\det \left(\vA \vD - \vA \vC \vA^{-1} \vB \right)
\ee
